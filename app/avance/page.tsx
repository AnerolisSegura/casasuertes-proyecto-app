          ...
          {obras.map((obra) => {
            ...
            return (
              <div key={obra.id} className="p-6 bg-white rounded-xl shadow-sm border border-slate-200 transition hover:shadow-md">
                ...
                {imagenes.length > 0 ? (
                  <div className="mb-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {imagenes.map((url, index) => (
                      <div key={index} className="overflow-hidden rounded-lg border border-slate-200 bg-slate-100 h-48 w-full">
                ...
                {/* Barra de Progreso (Estructura corregida al 100% de ancho) */}
